## -*- encoding: utf-8 -*-
## This file (example.sagetex.sage) was *autogenerated* from example.tex with sagetex.sty version 2020/08/12 v3.5.
import sagetex
_st_ = sagetex.SageTeXProcessor('example', version='2020/08/12 v3.5', version_check=True)
try:
...
try:
 ...
 _st_.inline(1, latex(mod(2021, 100)))
except:
 _st_.goboom(36)
try:
 _st_.current_tex_line = 38
 _st_.inline(2, latex(Integer(mod(2021, 100))^3))
except:
 _st_.goboom(38)
try:
 _st_.current_tex_line = 39
 _st_.inline(3, latex(2021%42))
except:
 _st_.goboom(39)
...
try:
 ...
 _st_.goboom(283)
print('SageTeX paused on example.tex line 293')
"""
try:
...
try:
 ...
 _st_.goboom(303)
"""
print('SageTeX unpaused on example.tex line 305')
